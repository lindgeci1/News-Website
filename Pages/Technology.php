...
$homeNews = $crud->getLatestNewsForTechnology(10); // Get latest 10 news items from "Home"
?>
<div class="main">
    <!-- Left Section -->
    <div class="left">
        <div class="box">
            ...
            <div class="newsBox1">
                ...
                if (!empty($homeNews)) {
                    ...
                    echo "<p>No news available in the Technology category.</p>";
                }
                ?>
            </div>
        </div>
