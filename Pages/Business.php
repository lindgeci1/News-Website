...
$homeNews = $crud->getLatestNewsForBusiness(10); // Get latest 10 news items from "Home"
?>
<div class="main">
    <!-- Left Section -->
    <div class="left">
        <div class="box">
            ...
            <div class="newsBox1">
                ...
                if (!empty($homeNews)) {
                    ...
                    echo "<p>No news available in the Business category.</p>";
                }
...
$crud = new CRUDAT_PER_LAJME();
$businessNews = $crud->getLatestNewsForBusiness(10); // Fetch the latest 10 news items for the "Business" category
?>
...
<div class="lajmi2">
    <div class="page2">
        <div class="box">
            ...
            <?php
            if (!empty($businessNews)) {
                foreach ($businessNews as $news) {
                    echo '<div class="mySlides fade">';
                    echo '<img src="../indexphoto/' . htmlspecialchars($news["foto"]) . '" alt="' . htmlspecialchars($news["newsName"]) . '">';
                    echo '</div>';
                }
            } else {
                echo "<p>No news available in the Business category.</p>";
